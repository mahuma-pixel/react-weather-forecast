...
<div className="container">
    <div className="row">
        ...
        <div className="col-sm-6 forecast"><span><img src="data:image/png;base64," alt="forecast"></img></span>
        <span className="temperature">23</span><span className="unit d-flex">°C</span></div>
    </div></div>
    <br/>
    <div className="container">
    <div className="row">
